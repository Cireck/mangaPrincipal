@forelse($mangas as $manga)
    <div class="element col-6 col-sm-6 col-md-4 col-lg-3 col-xl-2 mt-2 shadow" data-identifier="{{ $manga->id }}">
        <a href="{{ route('mangaShow', $manga) }}">
            <div class="thumbnail book book-thumbnail">
                ...
                <span class="demography {{ demographyManga($manga->demography) }}">{{ $manga->demography }}</span>
            </div>
        </a>
    </div>
@empty
