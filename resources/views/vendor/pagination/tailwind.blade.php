            ...
            <div>
                <span class="relative z-0 inline-flex shadow-sm rounded-md">
                    ...
                    @else
                        ...
                        rounded-l-md leading-5 hover:text-gray-400 focus:z-10 focus:outline-none
                    ...
                    @if ($paginator->hasMorePages())
                        ...
                        inline-flex items-center px-2 py-2 -ml-px text-sm font-medium text-gray-500
                        bg-white border border-gray-300 rounded-r-md leading-5 hover:text-gray-400
